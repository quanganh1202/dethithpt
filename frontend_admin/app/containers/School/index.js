              ...
              <Card>
                ...
                <CardBody>
                  <Table responsive hover striped>
                    ...
                    <tbody>
                      {this.renderSchoolRow(this.props.schools)}
                    </tbody>
                  </Table>
                </CardBody>
              </Card>
...
const withReducer = injectReducer({ key: 'school', reducer });
const withSaga = injectSaga({ key: 'school', saga });
