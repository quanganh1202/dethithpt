...
curl -X POST "$ES_HOST:9200/users/user/2?op_type=create" -H 'Content-Type: application/json' -d '{"name":"hehehe","email":"vuanhdung.khmt2@gmail.com","role":"admin","status": 2,"numOfDownloaded": 0,"numOfUploaded": 0, "money": 0}'

curl -X POST "$ES_HOST:9200/users/user/3?op_type=create" -H 'Content-Type: application/json' -d '{"name":"Anh Dung","email":"quanganh1202@gmail.com","role":"admin","status": 2,"numOfDownloaded": 0,"numOfUploaded": 0, "money": 0}'

curl -X POST "$ES_HOST:9200/users/user/4?op_type=create" -H 'Content-Type: application/json' -d '{"name":"Vu Anh Dung","email":"tdgalaxycorp@gmail.com","role":"admin","status": 2,"numOfDownloaded": 0,"numOfUploaded": 0, "money": 0}'

curl -X POST "$ES_HOST:9200/users/user/5?op_type=create" -H 'Content-Type: application/json' -d '{"name":"DungVA","email":"phamdung282@gmail.com","role":"admin","status": 2,"numOfDownloaded": 0,"numOfUploaded": 0, "money": 0}'

curl -X POST "$ES_HOST:9200/users/user/6?op_type=create" -H 'Content-Type: application/json' -d '{"name":"zzzz","email":"nguoiran2000@gmail.com","role":"admin","status": 2,"numOfDownloaded": 0,"numOfUploaded": 0, "money": 0}'
