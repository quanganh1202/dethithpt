...
export const GET_DOC_DETAILS_REQUEST =
  'thpt/DocumentDetails/GET_DOC_DETAILS/REQUEST';
export const GET_DOC_DETAILS_SUCCESS =
  'thpt/DocumentDetails/GET_DOC_DETAILS/SUCCESS';
